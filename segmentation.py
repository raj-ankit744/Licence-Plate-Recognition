...
# a license plate should be between 3% and 15% of the license plate,
# and height should be between 35% and 90%
# this will eliminate some
character_dimensions = (0.35*license_plate.shape[0], 0.90*license_plate.shape[0], 0.03*license_plate.shape[1], 0.15*license_plate.shape[1])
